...
class HelloRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hellostreamingworld.HelloRequest) */ {
 public:
  HelloRequest();
...
class HelloReply final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hellostreamingworld.HelloReply) */ {
 public:
  HelloReply();
  virtual ~HelloReply();
