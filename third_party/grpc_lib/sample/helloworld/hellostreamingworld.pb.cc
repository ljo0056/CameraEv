...
static void InitDefaultsHelloRequest_hellostreamingworld_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_HelloRequest_hellostreamingworld_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsHelloRequest_hellostreamingworld_2eproto}, {}};

static void InitDefaultsHelloReply_hellostreamingworld_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_HelloReply_hellostreamingworld_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsHelloReply_hellostreamingworld_2eproto}, {}};

void InitDefaults_hellostreamingworld_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_HelloRequest_hellostreamingworld_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_HelloReply_hellostreamingworld_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_hellostreamingworld_2eproto[2];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_hellostreamingworld_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_hellostreamingworld_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_hellostreamingworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 6, -1, sizeof(::hellostreamingworld::HelloReply)},
};
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_hellostreamingworld_2eproto = {
  {}, AddDescriptors_hellostreamingworld_2eproto, "hellostreamingworld.proto", schemas,
  file_default_instances, TableStruct_hellostreamingworld_2eproto::offsets,
...
const char descriptor_table_protodef_hellostreamingworld_2eproto[] =
  "\n\031hellostreamingworld.proto\022\023hellostream"
  "ingworld\"\034\n\014HelloRequest\022\014\n\004name\030\001 \001(\t\"\035"
  "\n\nHelloReply\022\017\n\007message\030\001 \001(\t2\272\001\n\014MultiG"
  "reeter\022R\n\010sayHello\022!.hellostreamingworld"
  ".HelloRequest\032\037.hellostreamingworld.Hell"
  "oReply\"\0000\001\022V\n\nSayHelloDb\022!.hellostreamin"
  "gworld.HelloRequest\032\037.hellostreamingworl"
  "d.HelloReply\"\000(\0010\001BH\n$io.grpc.examples.h"
  "ellostreamingworldB\030HelloStreamingWorldP"
  "rotoP\001\242\002\003HLWb\006proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_hellostreamingworld_2eproto = {
  false, InitDefaults_hellostreamingworld_2eproto, 
  descriptor_table_protodef_hellostreamingworld_2eproto,
  "hellostreamingworld.proto", &assign_descriptors_table_hellostreamingworld_2eproto, 380,
};

void AddDescriptors_hellostreamingworld_2eproto() {
  static constexpr ::google::protobuf::internal::InitFunc deps[1] =
  {
  };
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_hellostreamingworld_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_hellostreamingworld_2eproto = []() { AddDescriptors_hellostreamingworld_2eproto(); return true; }();
namespace hellostreamingworld {
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("hellostreamingworld.HelloRequest.name");
...
::google::protobuf::Metadata HelloRequest::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_hellostreamingworld_2eproto);
  return ::file_level_metadata_hellostreamingworld_2eproto[kIndexInFileMessages];
}
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("hellostreamingworld.HelloReply.message");
